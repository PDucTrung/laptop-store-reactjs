			...
			<Container className={classes.root}>
				<TableContainer component={Paper}>
					...
					<Table className={classes.table} aria-label="simple table">
						<TableHead>
							<TableRow>
								<TableCell>Tên nguời nhận</TableCell>
						...
						<TableBody>
							<TableRow>
								...
								{orderDetails.purchase_units[0].shipping.address.address_line_1 + ' - ' + orderDetails.purchase_units[0].shipping.address.admin_area_1+'-'
}
								</TableCell>
								<TableCell align="center">{orderDetails.purchase_units[0].shipping.address.postal_code}</TableCell>
								<TableCell align="center">{orderDetails.purchase_units[0].shipping.address.country_code}</TableCell>
							</TableRow>
						</TableBody>
					</Table>
